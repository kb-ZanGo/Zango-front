...
const emit = defineEmits(['update:isVerified', 'update:isFormValid', 'update:isLoading']);
...
const verifyAccount = async () => {
  ...
  try {
    ...
    const response = await axios.post('https://zango.site/api/boards/feedback/login', jsonData, {
      headers: {
