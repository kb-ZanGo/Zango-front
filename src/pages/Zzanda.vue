    ...
    <div class="container">
        ...
        <div class="list">
            ...
            <div class="extra-buttons" :class="{ show: showButtons }">
                ...
                <button class="extra-button multi-line" @click="goToGroupBuy">
                    공동<br />구매
                </button>
                <button class="extra-button" @click="goToFeedBack">
                    피드백
                </button>
            </div>
        </div>
...
export default {
    ...
    computed: {
        ...
        currentPageHoneyTips() {
            const start =
                (this.honeyTipCurrentPage - 1) * this.honeyTipItemsPerPage;
        ...
        honeyTipDisplayedPages() {
            let start = Math.max(
                1,
                this.honeyTipCurrentPage -
                    Math.floor(this.maxHoneyTipDisplayPages / 2)
            );
