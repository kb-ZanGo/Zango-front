            ...
            >
                ...
                <div v-else class="comment-edit">
                    ...
                    <div class="edit-buttons">
                        ...
                        <button class="cancel-btn" @click="cancelEdit(comment)">
                            취소
                        </button>
                    </div>
                </div>
    ...
    try {
        ...
        for (const comment of sortedComments) {
            ...
            try {
                ...
                console.error(
                    `댓글 ${comment.commentId}의 대댓글 조회 실패:`,
                    error
                );
                comment.replies = [];
            }
...
const updateComment = async (comment) => {
    try {
        await axios.put(`/api/comments/${comment.commentId}`, {
